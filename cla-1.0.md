...
Version 1.0
-----------
I agree to contribute to PV Repowering repository.
...
under the terms of the current PV Repowering license. 
Second, I agree that, in order to conform to any future open source 
software license(s) under which PV Repowering may be provided, the terms of 
...
to any successor manager and distributor of PV Repowering appointed by 
the U.S. Department of Energy, and to all recipients of 
a version of PV Repowering that includes my contributions, a non-exclusive, 
...
or by combination of my contributions with the version of PV Repowering 
to which they are contributed, to make, have made, use, offer to sell, 
sell, import, and otherwise transfer any version of PV Repowering that 
